...
FlightController::FlightController()
    : kalmanRoll(DEFAULT_Q_ANGLE, DEFAULT_Q_BIAS, DEFAULT_R_MEASURE), kalmanPitch(DEFAULT_Q_ANGLE, DEFAULT_Q_BIAS, DEFAULT_R_MEASURE), kalmanYaw(DEFAULT_Q_ANGLE, DEFAULT_Q_BIAS, DEFAULT_R_MEASURE), kalmanAltitude(DEFAULT_Q_ANGLE, DEFAULT_Q_BIAS, DEFAULT_R_MEASURE), pidRoll(DEFAULT_PID_P, DEFAULT_PID_I, DEFAULT_PID_D, DEFAULT_PID_MIN, DEFAULT_PID_MAX), pidPitch(DEFAULT_PID_P, DEFAULT_PID_I, DEFAULT_PID_D, DEFAULT_PID_MIN, DEFAULT_PID_MAX), pidYaw(DEFAULT_PID_P, DEFAULT_PID_I, DEFAULT_PID_D, DEFAULT_PID_MIN, DEFAULT_PID_MAX)
{
}
...
void FlightController::printSensorData() const
{
    ...
    Serial.print(F("Roll  (deg) - Raw: "));
    Serial.print(rawRoll);
    Serial.print(F(" Filtered: "));
    Serial.println(filteredRoll);
    Serial.print(F(" Rate: "));
    Serial.println(rawRollRate);

    Serial.print(F("Pitch (deg) - Raw: "));
    Serial.print(rawPitch);
    Serial.print(F(" Filtered: "));
    Serial.println(filteredPitch);
    Serial.print(F(" Rate: "));
    Serial.println(rawPitchRate);

    Serial.print(F("Yaw   (deg) - Raw: "));
    Serial.print(rawYaw);
    Serial.print(F(" Filtered: "));
